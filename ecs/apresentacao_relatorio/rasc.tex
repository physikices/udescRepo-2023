	...
	\begin{frame}{DGLAP}
		...
		\begin{frame}{DGLAP}
			...
			\begin{tikzpicture}[thick, scale=1, every node/.style={transform shape}]
				\node (a1){
						\begin{tikzpicture}[decoration={markings, mark= at position 0.5 with {\arrow{latex}}}]
							\input{img/splitting_01.tex}	
						\end{tikzpicture}
					};
					\node[right=.2cm of a1] (a2){
						\begin{tikzpicture}[decoration={markings, mark= at position 0.5 with {\arrow{latex}}}]
							\input{img/splitting_02.tex}	
						\end{tikzpicture}
					};
					\node[right=.2cm of a2] (a3){
						\begin{tikzpicture}[decoration={markings, mark= at position 0.5 with {\arrow{latex}}}]
							\input{img/splitting_03.tex}	
						\end{tikzpicture}
					};
					\node[right=.2cm of a3] (a4){
						\begin{tikzpicture}[decoration={markings, mark= at position 0.5 with {\arrow{latex}}}]
							\input{img/splitting_04.tex}	
						\end{tikzpicture}
					};
					\only<2->{
