...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  
	...
	integral = SGS0(A,B,0.001d0,phint) !SGS0 (limite inferior,limite superior,precisao,integrando ) : rotina de integracao
	...
	double precision function phint(ph) 
	implicit double precision(a-z) 
	common/raio/ Rc
	external rint
	...
	double precision function rint(r)
	implicit double precision (a-z)
