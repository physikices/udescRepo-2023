!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
! integral de sen(x) de zero a pi/2


	implicit double precision (a-z) 

	external fint !integrando chamado como funcao external
	...
	integral = SGS0 (A,B,0.001d0,fint) !SGS0 (limite inferior,limite superior,precisao,integrando ) : rotina de integracao
	...
	double precision function fint(x)
	implicit double precision(a-z)
